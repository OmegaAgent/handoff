...
cases:  23 from conformance/cases
...
…
0/23 passing
not conformant: 23 Level 1 case(s) failing — C-1, C-2, C-3, C-4, C-5, C-6, C-6b, C-7,
C-8, C-9, C-10, C-11, C-12, C-13, C-14, C-15, C-16, C-18, C-19, C-20, C-21, C-22, C-23
```
...
- §18 and the map both enumerate **23** Level 1 cases (C-1…C-16, C-6b, C-18…C-23) plus C-17 at
  Level 2. `conformance/cases/` currently holds **22** files.
...
the map edited down. All 23 Level 1 cases now exist on disk and all 23 run.
